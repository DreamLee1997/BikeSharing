                    ...
                    <FormItem label="当前状态" {...formItemLayout}>
                        {
                            getFieldDecorator('state',{
                                ...
                                <Select>
                                    ...
                                    <Option value="3">天之骄子</Option>
                                    <Option value="4">创业者</Option>
                                    <Option value="5">码奴</Option>
                                </Select>
                            )
                        }
                    </FormItem>
                    <FormItem label="爱好" {...formItemLayout}>
                        {
                            getFieldDecorator('hobby',{
                                ...
                                <Select mode="multiple">
                                    ...
                                    <Option value="2">滑雪</Option>
                                    <Option value="3">慢跑</Option>
                                    <Option value="4">看电影</Option>
                                    <Option value="5">听歌</Option>
                    ...
                    <FormItem label="生日" {...formItemLayout}>
                        {
                            getFieldDecorator('birthday',{
                                initialValue:moment('2019-03-06 12:00:58')
                            })(
                                <DatePicker
                                    showTime
                    ...
                    <FormItem {...offsetLayout} >
                        {
                            getFieldDecorator('read',{
                                ...
                                <Checkbox>我已阅读过<a href="#">共享单车协议</a></Checkbox>
                            )
                        }
                    </FormItem>
                    <FormItem {...offsetLayout} >
